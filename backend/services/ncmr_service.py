...
class NCMRService:
    ...
    def create_cara(data):
        ...
        try:
            ...
            cursor.execute('''SELECT "NCMR單號" FROM "不合格品單" WHERE "識別碼" = %s''', (ncmr_id,))
            ...
            conn.commit()
            return {"car_number": car_number, "ncmr_number": ncmr_number}
        except Exception as e:
            conn.rollback()
            raise e
        finally:
    ...
    def create_capa(data):
        ...
        try:
            ...
            conn.commit()
            return {"capa_number": capa_number, "ncmr_number": ncmr_number, "id": new_id}
        except Exception as e:
            conn.rollback()
            raise e
        finally:
